...
/**
 * NoiseGenerator class provides methods to generate pseudo-random noise based on a given seed.
 * It utilizes Perlin noise algorithm to generate smooth, continuous noise values.
 * @author Dan Nirel
 */
public class NoiseGenerator {
     ...
     *
     * @param seed can be anything you want.
    ...
    /*
     * Initializes the permutation array used in noise generation.
     */
    private void init() {
    ...
    /*
     * Generates smooth noise at the specified coordinates.
     *
    ...
    /*
     * Computes fade curves for the given value.
     *
     * @param t  the value to compute fade for.
    ...
    /*
     * Computes the gradient value for the given hash and coordinates.
     *
